...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(2, 1, NEO_GRB + NEO_KHZ800);
...
// ROY G BIV
static StepColorGradient rainbowWalkGradients[] = {
    &stepRedOrangeGradient,
...
void setup()
{
  ...
  dotstar.begin();
  // dotstar.setPixelColor(0, 64, 0, 0);
  dotstar.show();
